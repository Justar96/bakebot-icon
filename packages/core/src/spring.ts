 ...
 * module read as a description of behaviour — one gaze spring and one
 * deformation spring, each with its own damping ratio — rather than as an
 * integrator with behaviour mixed into it.
 */
